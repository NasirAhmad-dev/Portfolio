    ...
    <>
      <div className="flex flex-col items-center py-15 gap-10 mt-15  px-5 bg-gray-200 ">
        ...
        <p className="text-lg text-center text-gray-500">
          Passionate Web Developer dedicated to creating modern, responsive, and
          user-friendly websites. I enjoy turning creative ideas into functional
          digital experiences with clean design and efficient code.
        </p>
        <div className="flex gap-10 ">
          <div className="flex justify-center items-center hover:bg-orange-300 hover:duration-300 rounded-full p-2">
            <a
              href="https://www.facebook.com/nasirahmad.amiri.168894"
              target="_blank"
            >
          ...
          <div className="flex justify-center items-center hover:bg-orange-300 hover:duration-300 rounded-full p-2">
            <a
              href="https://github.com/NasirAhmad-dev/portfolio.git"
              target="_blank"
            >
